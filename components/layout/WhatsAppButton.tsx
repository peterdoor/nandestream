...
export default function WhatsAppButton({ href }: { href?: string }) {
  ...
  return (
    <a href={href} target="_blank" rel="noopener noreferrer"
      ...
      className="fixed bottom-5 right-5 z-[998] w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-xl hover:scale-110 transition-transform">
