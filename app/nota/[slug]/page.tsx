      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <article className="lg:col-span-2">
            ...
            {nota.bajada && (
              <p className="text-lg text-gray-500 leading-relaxed border-l-4 border-rojo pl-4 mb-6">{nota.bajada}</p>
            )}
            ...
            <div className="mt-8 pt-6 border-t border-gris-claro">
              ...
              <div className="flex gap-2 flex-wrap">
                <ShareBtn href={`https://wa.me/?text=${encodeURIComponent(nota.titulo + ' ' + notaUrl)}`} label="WhatsApp" color="bg-[#25D366]" />
                <ShareBtn href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(notaUrl)}`} label="Facebook" color="bg-[#1877F2]" />
                <ShareBtn href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(nota.titulo)}&url=${encodeURIComponent(notaUrl)}`} label="X / Twitter" color="bg-black" />
              </div>
            </div>
          </article>
