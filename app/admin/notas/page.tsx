import { getNotas } from '@/lib/sheets';
  ...
  return (
    <div className="min-h-screen bg-gris-claro">
      ...
      <div className="max-w-5xl mx-auto px-4 py-10">
        ...
        {notas.length === 0 ? (
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden">
            ...
            {notas.map((nota, i) => (
              <div
                key={nota.id}
                className={`grid grid-cols-12 gap-4 px-5 py-4 items-center border-b border-gris-claro last:border-0 hover:bg-gris-claro/50 transition-colors ${i % 2 === 0 ? '' : 'bg-white'}`}
              >
                ...
                <div className="col-span-2 text-sm text-gris-medio truncate">
                  {nota.autor}
                </div>
                ...
                <div className="col-span-1">
                  {nota.destacado ? (
                    ...
                    <span className="text-gris-medio text-sm">—</span>
                  )}
                </div>
              </div>
            ))}
        ...
        <p className="text-xs text-gris-medio mt-4 text-center">
          Para editar o eliminar una nota, hacelo directamente en el{' '}
          <a
